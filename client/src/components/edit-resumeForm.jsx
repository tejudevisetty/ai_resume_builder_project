                ...
                <div className="border border-secondary w-75 p-5 font-monospace">
                    <dl>
                        ...
                        <dd>
                            ...
                            <button type="button" className="get-started p-1 mt-2" onClick={GenerateSummaryFromAI} >Generate from AI</button>
                        ...
                        <button type="button" className="get-started p-1 mt-2" onClick={GenerateProSummaryFromAI} >Generate with AI</button>
                    </dl>
