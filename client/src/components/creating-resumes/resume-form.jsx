                ...
                <div className="resume-form mb-5 w-75 p-5 font-monospace bg-white">
                    <dl>
                        ...
                        <dd>
                            ...
                            <button type="button" className="ai-btn p-2 mt-2" onClick={GenerateSummaryFromAI} >Generate from AI</button><span className=" text-secondary" > *Provide Job title</span>
                        ...
                        <button type="button" className="ai-btn p-2 mt-2" onClick={GenerateProSummaryFromAI} >Generate with AI</button><span className=" text-secondary" > *Provide Job designation and company name</span>
                    </dl>
